...
class TurnState:
    ...
    lt_examples: list[Any] = field(default_factory=list)
...
def _format_lt_examples(lt_examples: list[Any]) -> str:
    """
    ...
    async def run(self, request: QueryRequest) -> QueryResponse:
        ...
        try:
            ...
            for attempt in range(MAX_ATTEMPTS):
                ...
                df_refs: dict[str, Any] | None = None
...
def _dialect_for_request(request: QueryRequest) -> str:
    return cast(str, request.dialect)
